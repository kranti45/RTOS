 ...
 *
 ******************************************************************************
 /* Create four task functions vLedTask1(), vLedTask2(), vLedTask3() and vLedTask4() which will toggle four different LEDs with different rate. Create four real-time tasks to execute these functions.
*/
#include <stdint.h>
#include <stdio.h>
#include "stm32f4xx.h"
